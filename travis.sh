...
export SDK_URL=https://Crowncoincore.org/depends-sources/sdks
...
#script:
if [ "$CHECK_DOC" = 1 -a "$TRAVIS_REPO_SLUG" = "Crowncoin/Crowncoin" -a "$TRAVIS_PULL_REQUEST" = "false" ]; then 
	while read LINE; do 
