...
class BIP66Test(CrowncoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # Crowncoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and Crowncoind produces more specific reject
            # reasons.
