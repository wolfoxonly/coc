...
# TestNode: A peer we use to send messages to Crowncoind, and store responses.
...
class CompactBlocksTest(CrowncoinTestFramework):
    ...
    # This test actually causes Crowncoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that Crowncoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for Crowncoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # Crowncoind will not send blocktxn responses for blocks whose height is
