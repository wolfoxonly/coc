...
By default, Crowncoind will dump mempool on shutdown and
...
class MempoolPersistTest(CrowncoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give Crowncoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent Crowncoind from writing mempool.dat to disk. Verify that `savemempool` fails")
