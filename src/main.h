...
static const int64 MAX_MONEY = 1099833113 * COIN;
...
static const int COINBASE_MATURITY_PPC = 5;//<zxb>for test
/** Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp. */
static const int STAKE_TARGET_SPACING = 2 * 5;//改为2分钟了 10 * 60; // 10-minute block spacing 
static const int STAKE_MIN_AGE = 60 * 2; // minimum age for coin age<zxb>
...
#ifdef TESTING
void CrowncoinMiner(CWallet *pwallet, bool fProofOfStake, bool fGenerateSingleBlock = false);
#else
...
public:
    ...
    */
    ...
    /** Amount of Crowncoins spent by this transaction.
    ...
    /** Amount of Crowncoins coming in to this transaction
...
public:
    ...
    /**
     * Duplicate from Crowncoinrpc that originaly define this method.
