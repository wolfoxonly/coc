...
BOOST_AUTO_TEST_CASE(base58_keys_valid_gen)
{
    ...
    BOOST_FOREACH(Value& tv, tests)
    {
        ...
        else
        {
            ...
            BOOST_CHECK_MESSAGE(boost::apply_visitor(CCrowncoinAddressVisitor(&addrOut), dest), "encode dest: " + strTest);
    ...
    BOOST_CHECK(!boost::apply_visitor(CCrowncoinAddressVisitor(&dummyAddr), nodest));
