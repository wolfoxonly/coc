...
std::string HelpMessage(HelpMessageMode hmm)
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: Crowncoind.pid)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    //
    // ppcoin: -mintxfee and -minrelaytxfee options of Crowncoin disabled
    ...
    GenerateCrowncoins(GetBoolArg("-gen", false), pwalletMain);
