...
// Copyright (c) 2012-2017 The Crowncoin developers
...
Value getaddressesbyaccount(const Array& params, bool fHelp)
{
    ...
    Array ret;
    BOOST_FOREACH(const PAIRTYPE(CCrowncoinAddress, string)& item, pwalletMain->mapAddressBook)
    {
        ...
        BOOST_FOREACH(CTxDestination address, grouping)
        {
            ...
            addressInfo.push_back(ValueFromAmount(balances[address]));
            {
                ...
                if (pwalletMain->mapAddressBook.find(CCrowncoinAddress(address).Get()) != pwalletMain->mapAddressBook.end())
                    addressInfo.push_back(pwalletMain->mapAddressBook.find(CCrowncoinAddress(address).Get())->second);
            }
...
void ThreadTopUpKeyPool(void* parg)
{
    ...
    RenameThread("Crowncoin-key-top");
...
void ThreadCleanWalletPassphrase(void* parg)
{
    ...
    RenameThread("Crowncoin-lock-wa");
