...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    loop
    {
        ...
        BOOST_FOREACH(const PAIRTYPE(QString, qint64) &payee, CoinControlDialog::payAddresses)
        {
            ...
            scriptPubKey.SetDestination(CCrowncoinAddress(address.toStdString()).Get());
    ...
    int nDisplayUnit = CrowncoinUnits::BTC;
    ...
    l7->setToolTip(tr("This label turns red, if any recipient receives an amount smaller than %1.\n\n This means the transaction will be rejected.").arg(CrowncoinUnits::formatWithUnit(nDisplayUnit, CENT)));
    l8->setToolTip(tr("If the change is smaller than %1 it will be added to the fees.").arg(CrowncoinUnits::formatWithUnit(nDisplayUnit, CENT)));
