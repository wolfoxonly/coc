...
QString CrowncoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("COC");//zxb定义名字
...
QString CrowncoinUnits::format(int unit, qint64 n, bool fPlus, bool trimzeros)
{
...
QString CrowncoinUnits::formatWithUnit(int unit, qint64 amount, bool plussign, bool trimzeros)
{
