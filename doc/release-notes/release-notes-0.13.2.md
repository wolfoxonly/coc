Crowncoin Core version 0.13.2 is now available from:

  <https://Crowncoin.org/bin/Crowncoin-core-0.13.2/>
...
- #8908 `4a974b2` Update Crowncoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow Crowncoin-tx to create v2 transactions (btcdrak)
