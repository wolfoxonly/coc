Crowncoin Core version 0.10.4 is now available from:

  <https://Crowncoin.org/bin/Crowncoin-core-0.10.4/>
...
- #6953 `43c2789` Split Crowncoin-tx into its own package
- #6953 `dfe0d4d` Include Crowncoin-tx binary on Debian/Ubuntu
