Crowncoin Core version 0.9.4 is now available from:

  https://Crowncoin.org/bin/0.9.4/
...
this update is incompatible with the Crowncoin system and could lead to consensus
forks.

Crowncoin Core released binaries from https://Crowncoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~Crowncoin/+archive/ubuntu/Crowncoin
- A third-party or self-compiled Crowncoin Core

upgrade to Crowncoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
