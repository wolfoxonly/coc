...
Crowncoin Core version *version* is now available from:

  <https://Crowncoin.org/bin/Crowncoin-core-*version*/>
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile Crowncoin Core is now 4.8. No effort will be
