...
This document provides guidelines for internationalization of the Crowncoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `Crowncoin_en.ts` remains unchanged.
