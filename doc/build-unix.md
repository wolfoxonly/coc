UNIX BUILD NOTES
====================
Some notes on how to build Crowncoin Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Note
---------------------
Always use absolute paths to configure and compile Crowncoin and the dependencies,
...
memory available when compiling Crowncoin Core. On systems with less, gcc can be
...
**For Ubuntu only:** db4.8 packages are available [here](https://launchpad.net/~Crowncoin/+archive/Crowncoin).
...
See the section "Disable-wallet mode" to build Crowncoin Core without wallet.
...
`--with-incompatible-bdb` according to the [PKGBUILD](https://projects.archlinux.org/svntogit/community.git/tree/Crowncoin/trunk/PKGBUILD).
As mentioned above, when maintaining portability of the wallet between the standard Crowncoin Core distributions and independently built
